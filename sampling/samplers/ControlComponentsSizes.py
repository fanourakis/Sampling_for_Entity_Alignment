...
class ControlComponentsSizes:
    ...
    def RJ_only_p(kg1_mdi, kg2_mdi, kg1_mun, kg2_mun, sampling_size, p):
        ...
        comps_dict1 = ControlComponentsSizes.get_comps_dict(list(comp1))
        comps_dict2 = ControlComponentsSizes.get_comps_dict(list(comp2))
        ...
        disconnected2 = []
        isKG1 = True
        curr_node, disconnected1 = ControlComponentsSizes.get_curr_node(comps_dict1, [])
        ...
        while sampled_filtered_kg.number_of_nodes() < sampling_size and sampled_filtered_kg2.number_of_nodes() < sampling_size:
            ...
            if isKG1:
                comps_dict1 = ControlComponentsSizes.my_remove_node(curr_node, comps_dict1)
                comps_dict1 = ControlComponentsSizes.my_remove_node(chosen_node, comps_dict1)
            else:
                comps_dict2 = ControlComponentsSizes.my_remove_node(curr_node, comps_dict2)
                comps_dict2 = ControlComponentsSizes.my_remove_node(chosen_node, comps_dict2)
            ...
            if choice == 'random_walk':
                ...
                isKG1 = not isKG1
                if isKG1:
                    curr_node, disconnected1 = ControlComponentsSizes.get_curr_node(comps_dict1, disconnected1)
                else:
                    curr_node, disconnected2 = ControlComponentsSizes.get_curr_node(comps_dict2, disconnected2)
