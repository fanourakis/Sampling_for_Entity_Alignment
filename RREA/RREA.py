...
if sample == "sampled":
    run_path = "../datasets/sampled/" + dataset + "_sampled/" + conf_id + "/"
elif sample == "original":
    run_path = "../datasets/original/" + dataset + "_RREA/"
...
if export_results == True:
    dest_path = "exp_results/" + "/" + dataset + "/" + conf_id + "/"
...
for turn in range(5):
    ...
    if turn == 4:
        ...
        if export_results == True:
            file_to_write = open("exp_results/"  + "/" + dataset + "/" + conf_id + "/" + dataset + "_sim_lists_" + csls_mode + "_" + sample + ".pickle", "wb")
            pickle.dump(neighbors_sim_dict, file_to_write)


            file_to_write3 = open("exp_results/"  + "/" + dataset + "/" + conf_id + "/" + dataset + "_acc_" + csls_mode + "_" + sample + ".pickle", "wb")
